...
strUsage += "\n" + _("Masternode options:") + "\n";
    ...
    strUsage += "  -anonymizestakecoinamount=<n> " + _("Keep N Stakecoin anonymized (default: 0)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    nAnonymizeStakecoinAmount = GetArg("-anonymizestakecoinamount", 0);
    if(nAnonymizeStakecoinAmount > 999999) nAnonymizeStakecoinAmount = 999999;
    if(nAnonymizeStakecoinAmount < 2) nAnonymizeStakecoinAmount = 2;
    ...
    if(fEnableInstantX){
        ...
        if(nInstantXDepth < 0) nAnonymizeStakecoinAmount = 0;
    } else {
        nInstantXDepth = 0;
    }
    ...
    LogPrintf("Anonymize Stakecoin Amount %d\n", nAnonymizeStakecoinAmount);
